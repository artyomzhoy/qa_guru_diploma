...
Весь проект выполнен на языке <code>Python</code>, а также дополнительно:
 - для API-тестов применялись: <code>Requests</code>, <code>JSONSchema</code>, <code>JCurlify</code>.
...
### <a href='https://github.com/artyomzhoy/qa_guru_diploma/tree/main/tests/api'>Сценарии API-тестов</a>
 ...
 - **Создание/удаление** комментария на публикации;
...
4. Теперь можно подставить полученные данные ACCOUNT_USERNAME, CLIENT_ID и ACCESS_TOKEN в личный .env файл или настройки job в jenkins и успешно провести тестирование.
